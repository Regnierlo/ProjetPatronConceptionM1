...
public class Pilotee extends Decorator{
	...
	/*
	 * affecte un nouvel état a l'atat courant
	 */
	 ...
	 * si un clic est effectuer cette focntion est appelee.
	 ...
	 * et affecte les position aux variable afin de calculer lors du relachement du clic la vitesse d ela souris
	 */
	@Override
